...
public class ZlmVideoRepo {
    ...
    public List<String> getPlaybackLinks(String channelSipId, String dvrIp, int dvrPort) {
    ...
    private List<String> generatePlaybackLinks(String streamId) {
        List<String> links = new ArrayList<>();
        String app = "rtp";

        links.add("ws://" + zlmPublicIp + "/" + app + "/" + streamId + ".live.flv");
        links.add("http://" + zlmPublicIp + "/" + app + "/" + streamId + ".live.flv");
        links.add("http://" + zlmPublicIp + "/" + app + "/" + streamId + "/hls.m3u8");
        links.add("webrtc://" + zlmPublicIp + "/index/api/webrtc?app=" + app + "&stream=" + streamId + "&type=play");
        links.add("rtsp://" + zlmPublicIp + "/" + app + "/" + streamId);
